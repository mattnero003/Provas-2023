...
# 2. Criar o menu e lógica associada
...
def main():
    while True:
        ...
        if choice == 7:
            ...
            print(f"Vetor antes da ordenação: {arr}")

            if choice == 1:
                print(f"Tempo de execução do Bubble Sort: {time_algorithm(bubble_sort, arr)} segundos")
                print(f"Vetor após ordenação: {bubble_sort(arr)}")
            elif choice == 2:
                print(f"Tempo de execução do Insertion Sort: {time_algorithm(insertion_sort, arr)} segundos")
                print(f"Vetor após ordenação: {insertion_sort(arr)}")
            elif choice == 3:
                print(f"Tempo de execução do Selection Sort: {time_algorithm(selection_sort, arr)} segundos")
                print(f"Vetor após ordenação: {selection_sort(arr)}")
            elif choice == 4:
                print(f"Tempo de execução do Merge Sort: {time_algorithm(merge_sort, arr)} segundos")
                print(f"Vetor após ordenação: {merge_sort(arr)}")
            elif choice == 5:
                print(f"Tempo de execução do Quicksort: {time_algorithm(quicksort, arr)} segundos")
                print(f"Vetor após ordenação: {quicksort(arr)}")
        elif choice == 6:
            sizes = [10000, 30000]
